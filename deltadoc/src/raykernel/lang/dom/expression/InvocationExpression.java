...
/**
 * Calling a method
 * Separate class for static method call?
 * @author buse
 *
 */
public class InvocationExpression extends ExpressionCondition
{
	Expression target; //thing method is invoked on (possibly null)
	
	List<Expression> parameters; //arguments
	
	String method;
	
	public InvocationExpression(Expression target, String method, List<Expression> parameters)
	{
		this.target = target;
		this.method = method;
